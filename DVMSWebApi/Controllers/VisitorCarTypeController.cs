...
{ 
    ...
    [ODataRoutePrefix("VisitorCarType")]
    public class VisitorCarTypeController : ODataController
    {
        private DVMSContext _db;

        public VisitorCarTypeController(DVMSContext DVMSContext)
        {
            _db = DVMSContext;
        }
        ...
        {
            return Ok(_db.visitorCarType.AsQueryable());
        }
        ...
        {
            return Ok(_db.visitorCarType.Find(key));
        }
        ...
        {
            return Ok(_db.visitorCarType.Where(t => t.visitorCarType_Name.StartsWith("A")));
        }
    }
}
